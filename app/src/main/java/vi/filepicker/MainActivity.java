...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private void addThemToView(ArrayList<Uri> imagePaths, ArrayList<Uri> docPaths) {
        ...
        /*for (Uri filePath : filePaths) {
            ...
            Log.e("path2", FileUtils.INSTANCE.getPathFromUri(this, filePath));
        }*/
    ...
    public void onPickPhoto() {
        ...
        if ((docPaths.size() + photoPaths.size()) == MAX_ATTACHMENT_COUNT) {
            ...
            FilePickerBuilder.getInstance()
                    ...
                    .setCameraImagePlaceholder(R.drawable.custom_camera)
                    .setCameraVideoPlaceholder(R.drawable.ic_baseline_videocam_24)
